...
ActiveRecord::Schema.define(version: 2022_05_05_201041) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.integer "user_id", null: false
    t.index ["liked_item_id", "liked_item_type"], name: "index_likes_on_liked_item_id_and_liked_item_type", unique: true
  end
